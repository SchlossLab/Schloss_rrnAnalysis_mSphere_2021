...
To investigate the variation in the number of copies of the 16S rRNA gene per genome as well as the intragenomic variation among copies of the 16S rRNA gene, I obtained reference 16S rRNA sequences from the rrn copy number database (rrnDB; CITATION). Among the XX,XXX genomes represented in the rrnDB, each genome had between X (e.g. XXXXXXX) and XX (e.g. XXXXXXX) copies of the rrn operon. As the number of copies of the operon in a genome increased, the number of variants of the 16S rRNA gene in each genome also increased (**FIGURE**). On average, there were XXX variants per copy of the full length 16S rRNA gene and an average of XXX, XXX, and XXX variants when considering the V4, V3-V4, and V4-V5 regions of the gene. Although a species tended to have a consistent number of 16S rRNA gene copies per genome, the number of total variants increased with the number of genomes that were sampled (**FIGURE**). For example, M. tuberculosis generally only had one copy of the gene per genome, but across the XXX genomes that have been sequenced there were XX versions of the gene. Similarly, a E. coli genome typically had 7 copies of the 16S rRNA gene with between X and X distinct full length sequences per genome. Across the XXX genomes that have been sequenced, there were XXX different variants of the gene. These observations highlight the risk of selecting a threshold for defining units of inference that is too narrow because it is possible to split a single genome into multiple units.
